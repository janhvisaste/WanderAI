...
const footerLinks = {
  Product: ['AI Planner', 'Trip Dashboard', 'Share Trips', 'Weather', 'Maps'],
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-10">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-dark-500 text-sm leading-relaxed mb-6">
              AI-powered travel planning that transforms how you explore the world.
            </p>
            <div className="flex gap-3">
              {socialIcons.map((social) => (
                <a
                  key={social.name}
                  href="#"
                  className="w-9 h-9 rounded-lg glass flex items-center justify-center text-dark-400 hover:text-primary-400 hover:bg-primary-500/10 transition-all duration-300"
          ...
          {Object.entries(footerLinks).map(([title, links]) => (
            <div key={title}>
              <h4 className="font-display text-sm text-white tracking-wider mb-4 uppercase">
                {title}
              </h4>
              <ul className="space-y-2.5">
                {links.map((link) => (
                  <li key={link}>
                    <a
                      href="#"
                      className="text-dark-500 text-sm hover:text-primary-400 transition-colors duration-300"
                    >
                      {link}
                    </a>
                  </li>
        ...
        <div className="mt-16 pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-dark-600 text-sm">
            © 2025 WanderAI. All rights reserved. Crafted with ❤️ for travelers worldwide.
          </p>
          <div className="flex items-center gap-6">
            <a href="#" className="text-dark-600 text-sm hover:text-dark-400 transition-colors">
              Privacy
            </a>
            <a href="#" className="text-dark-600 text-sm hover:text-dark-400 transition-colors">
              Terms
